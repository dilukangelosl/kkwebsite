...
function createRandomStars(){
  ...
  for (let i = 0; i < numStars; i++) {
    ...
    container.classList.add(`animate-[pulse_${puslseSeconds}s_ease-in-out_infinite]`);
